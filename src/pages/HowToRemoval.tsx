      ...
      <section className="pt-32 pb-10 md:pt-40 md:pb-12">
        <div className="container mx-auto px-6">
          ...
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-10">
            ...
            <span className="text-foreground">Removing Your Set</span>
          </nav>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center mb-8">
              <div className="w-32 h-32 rounded-full bg-primary/5 flex items-center justify-center">
                <div className="w-24 h-24 rounded-full bg-gradient-to-br from-secondary/40 to-primary/8 border border-border/30 flex items-center justify-center shadow-sm">
                  <Droplets className="w-12 h-12 text-primary/70" />
                </div>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {removalMethods.map((method, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-secondary/10 border border-border/50 rounded-xl p-6 md:p-8 relative"
                >
                  {/* Badge */}
